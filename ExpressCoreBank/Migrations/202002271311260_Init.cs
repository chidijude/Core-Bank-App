namespace ExpressCoreBank.Migrations
{
    ...
    public partial class Init : DbMigration
    {
                ...
                c => new
                    {
                        ...
                        AccountBalance = c.Long(),
                        Branch = c.Int(nullable: false),
                        AccountType_Id = c.Byte(nullable: false),
                    })
                .PrimaryKey(t => t.Id)
                .ForeignKey("dbo.AccountTypes", t => t.AccountType_Id, cascadeDelete: true)
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.CustomerAccounts", "AccountType_Id", "dbo.AccountTypes");
            ...
            DropIndex("dbo.CustomerAccounts", new[] { "AccountType_Id" });
